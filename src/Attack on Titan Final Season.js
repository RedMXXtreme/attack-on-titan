...
const AttackonTitanFinalSeason = () => {
  const videos = [
    { id: 1, HD1: "https://2anime.xyz/embed/shingeki-no-kyojin-the-final-season-kanketsu-hen-dub-episode-1", HD2: "https://megaplay.buzz/stream/s-2/99029/dub", HDSUB1: "https://2anime.xyz/embed/shingeki-no-kyojin-the-final-season-kanketsu-hen-episode-1", HDSUB2: "https://megaplay.buzz/stream/s-2/99029/sub" },
    { id: 2, HD1: "https://2anime.xyz/embed/shingeki-no-kyojin-the-final-season-kanketsu-hen-dub-episode-2", HD2: "https://megaplay.buzz/stream/s-2/109212/dub", HDSUB1: "https://2anime.xyz/embed/shingeki-no-kyojin-the-final-season-kanketsu-hen-episode-2", HDSUB2: "https://megaplay.buzz/stream/s-2/109212/sub" },
  ]; 
    ...
    <nav className="bg-gray-900 p-4 flex items-center justify-between sticky top-0 z-10 shadow-lg">
     ...
     { /* Main Page Content */}
        <div className="flex flex-col lg:flex-row p-4 gap-4">
            ...
            <img
          src="https://static1.animekai.to/a0/i/f/68/6766493f4e009.jpg"
          alt="Anime poster"
          ...
          <iframe
            ...
            allow="autoplay" 
            allowFullScreen
            style={{ backgroundImage: "url('https://play-lh.googleusercontent.com/GGhC4SM43-ZmWjOi441wrH34jjrDhdTDkuWrt1IFX375aOWJelYHVqruAEJXgTHGmThbhfQ3Wbg=w1296-h2160')" }}
          ></iframe>
            </div>
...
export default AttackonTitanFinalSeason;